...
export { Str, StrUtil, DateTime, DateField, WeekDay, MonthField, DateUtil, NumberUtil, Throttle, Debounce, FileUtil, HexUtil, FileTypeMagicMap, FileTypeMimeMap, ObjectUtil, DesensitizedUtil, ArrayUtil, PatternPool, ValidateUtil, ImgUtil, IDUtil, SnowflakeIdWorker, CryptoUtil, CryptoGroup, JSONUtil, JSONType, UrlUtil, TreeUtil, ExePool, Executes, ChineseDateUtil, ChineseDate, Long };
declare const Baitu: typeof values;
