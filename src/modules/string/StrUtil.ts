...
export class StrUtil {
	 ...
	 * @param str 字符串
	 */
	static isBlank(str?: string | null): str is undefined | null | "" {
	 ...
	 * @param str 字符串
	 */
	static isNotEmpty(str?: string | null): str is string {
	 ...
	 * @param str 字符串数组
	 */
	static isAnyBlank(...str: string[]): boolean {
	 ...
	 * @param str 字符串数组
	 */
	static isNoneBlank(...str: string[]): boolean {
	 ...
	 * @param str 字符串数组
	 */
	static isAllBlank(...str: string[]): boolean {
	 ...
	 * @param str 字符串数组
	 */
	static isAnyEmpty(...str: string[]): boolean {
	 ...
	 * @param str 字符串数组
	 */
	static isNoneEmpty(...str: string[]): boolean {
	 ...
	 * @param str 字符串数组
	 */
	static isAllEmpty(...str: string[]): boolean {
	 ...
	 * @param spacer 连接符 默认-
	 */
	static toKebab(str: string, spacer: string = "-") {
	 ...
	 */
	static toHump(str: string, ...spacers: string[]) {
		if (ArrayUtil.isEmpty(spacers)) {
			spacers = [
				"-", "_",
			];
		}
		return str.replace(new RegExp("[" + spacers.join("|") + "](\\w)", "g"), (_, c) =>
			c ? c.toUpperCase() : ""
		);
	}
	 ...
	 * @param map 参数
	 */
	static formatMap(str: string, map: Record<string, string | number | boolean>) {
	 ...
	 */
	static appendIfNotEmpty(str: string, appends: string) {
	 ...
	 */
	static subLen(str: string, subLen: number, fromIndex?: number) {
	 ...
	 * @param endIndex 结束下标
	 */
	static subReverse(str: string, startIndex: number, endIndex?: number) {
	 ...
	 */
	static subReverseLen(str: string, subLen: number, fromIndex?: number) {
		fromIndex = fromIndex || 0;
		const endIndex = fromIndex < 0 ? fromIndex - subLen : subLen + fromIndex;
