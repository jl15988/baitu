...
export class GanZhi {
	 ...
	 * @param year 农历年
	 */
	static getYearIndex(year: number) {
	 ...
	 * @param index 干支索引
	 */
	static getGan(index: number): string {
	 ...
	 * @param index 地支索引
	 */
	static getZhi(index: number): string {
	 ...
	 * @param year 年份
	 */
	static getYearGan(year: number): string {
	 ...
	 * @param year 年份
	 */
	static getYearZhi(year: number): string {
	 ...
	 * @param day 公历天
	 */
	static getMonthIndex(year: number, month: number, day: number): number {
		// 获取所在节气的公历第一天
	 ...
	 * @param day 公历天
	 */
	static getMonthGan(year: number, month: number, day: number): string {
	 ...
	 * @param day 公历天
	 */
	static getMonthZhi(year: number, month: number, day: number): string {
	 ...
	 * @param day 公历天
	 */
	static getMonthGanZhi(year: number, month: number, day: number): string {
	 ...
	 * @param day 公历天
	 */
	static getDayIndex(year: number, month: number, day: number): number {
	 ...
	 * @param day 公历天
	 */
	static getDayGan(year: number, month: number, day: number): string {
	 ...
	 * @param day 公历天
	 */
	static getDayZhi(year: number, month: number, day: number): string {
	 ...
	 * @param day 公历天
	 */
	static getDayGanZhi(year: number, month: number, day: number): string {
	 ...
	 * @param day 公历天
	 */
	static fullGanZhi(year: number, month: number, day: number): string {
		return this.getYearGanZhi(year).concat(
			"年",
			" ",
			this.getMonthGanZhi(year, month, day),
			"月",
			" ",
			this.getDayGanZhi(year, month, day),
			"日"
		);
	}
}
